...
export const Features = () => {
    return (
        <div className='flex flex-col lg:flex-row gap-24 lg:gap-16 justify-around mt-12 lg:mt-24 mb-7  '>
            {features.map(item => <div key={item.title} className='flex flex-col  justify-center items-center gap-4 p-8 lg:pt-32 pt-28 rounded-app flex-1 bg-[#080807] duration-150 transition-all text-dark-Font top-0 hover:top-8 hover: border border-black hover:border-yellow-500 hover:shadow-card   relative'>
